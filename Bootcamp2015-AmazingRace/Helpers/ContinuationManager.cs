...
namespace Bootcamp2015.AmazingRace.Helpers
{
    ...
    public class ContinuationManager
    {
        ...
        internal void Continue(IContinuationActivatedEventArgs args, Frame rootFrame)
        {
            ...
            var rootFrameDataContext = (rootFrame.Content as FrameworkElement).DataContext;
            switch (args.Kind)
            {
                case ActivationKind.PickFileContinuation:
                    ...
                    else if (rootFrameDataContext != null)
                    {
                        var rootFrameViewModel = rootFrameDataContext as IFileOpenPickerContinuable;
                        if (rootFrameViewModel != null)
                        {
                            rootFrameViewModel.ContinueFileOpenPicker(args as FileOpenPickerContinuationEventArgs);
                        }
                    }
                    break;
                ...
                case ActivationKind.PickSaveFileContinuation:
                    ...
                    {
                        var rootFrameViewModel = rootFrameDataContext as IFileSavePickerContinuable;
                        if (rootFrameViewModel != null)
                        {
                            rootFrameViewModel.ContinueFileSavePicker(args as FileSavePickerContinuationEventArgs);
                        }
                    }
                    break;
                ...
                case ActivationKind.PickFolderContinuation:
                    ...
                    {
                        var rootFrameViewModel = rootFrameDataContext as IFolderPickerContinuable;
                        if (rootFrameViewModel != null)
                        {
                            rootFrameViewModel.ContinueFolderPicker(args as FolderPickerContinuationEventArgs);
                        }
                    }
                    break;
                ...
                case ActivationKind.WebAuthenticationBrokerContinuation:
                    ...
                    {
                        var rootFrameViewModel = rootFrameDataContext as IWebAuthenticationContinuable;
                        if (rootFrameViewModel != null)
                        {
                            rootFrameViewModel.ContinueWebAuthentication(args as WebAuthenticationBrokerContinuationEventArgs);
                        }
                    }
                    break;
            }
    ...
    /// <summary>
    /// Implement this interface if your page invokes the file open picker API.
    /// </summary>
    ...
    /// <summary>
    /// Implement this interface if your page invokes the file save picker API
    /// </summary>
    ...
    /// <summary>
    /// Implement this interface if your page invokes the web authentication broker
    /// </summary>
